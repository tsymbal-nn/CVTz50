        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    String readMessage = new String(buffer, 0, bytes);  // Fixing Bluetooth Chat Sample for handling fast input sequence
                    // Send the obtained bytes to the UI Activity
                    mHandler.obtainMessage(Constants.MESSAGE_READ, bytes, -1, readMessage) // Fixing Bluetooth Chat Sample for handling fast input sequence
                            .sendToTarget();
                } catch (IOException e) {
